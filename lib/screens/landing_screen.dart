...
class LandingScreenMobile extends StatelessWidget with ChangeNotifier {
  ...
  void _submitName() {
    ...
    if (isValidUsername) {
      ...
      nameFieldKey.currentState.save();
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider<LandingScreenMobile>(
      create: (_) => LandingScreenMobile(),
      builder: (context, _) =>
          // child:
          Scaffold(
                      ...
                      child: Form(
                        ...
                        child: TextFormField(
                          ...
                          onSaved: (val) {
                            ...
                            print(val);
                            Navigator.of(context)
                                .pushNamed(RankScreen.routeName);
                          },
                        ),
                      ),
                    ),
